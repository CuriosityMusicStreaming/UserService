...
type config struct {
	...
	DatabaseHost     string `envconfig:"db_host" default:"userservice-db"`
	DatabaseName     string `envconfig:"db_name" default:"userservice"`
	...
	Salt string `envconfig:"hasher_salt"`
}

func (c *config) HasherSalt() string {
	return c.Salt
}
